...
public class EditWhiteListActivityStartsWith extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.white_list_startwith);
    ...
    public void add(View v) {
            try {
                if (!StartWith.getText().equals("")) {
                    ...
                    val.put("ct", "0");
                    db.insert("whitlist_call_StartWith", null, val);
                    popup();
