...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            db.execSQL("create table blklst_call_StartWith( StartWith TEXT , ct TEXT)");
            db.execSQL("create table blklst_call_EndsWith( EndsWith TEXT , ct TEXT)");
            db.execSQL("create table whitlist_call( ph_no TEXT , blk TEXT)");
            db.execSQL("create table whitlist_call_StartWith( StartWith TEXT , ct TEXT)");
            db.execSQL("create table whitlist_call_EndsWith( EndsWith TEXT , ct TEXT)");
...
//            db.execSQL("create table logs( ph_no TEXT , ser TEXT,num TEXT)");
